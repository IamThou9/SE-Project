          ...
          <Row>
            ...
            <Col md={6}>
              <Form.Group className="inputForm">
                ...
                <Form.Control type="number" id="gradyear" className="input" placeholder="Graduating Year" required onChange={handleChange} />
              </Form.Group>
            </Col>
          </Row>
          <Row>
            ...
            <Form.Group className="inputForm">
                ...
                <Form.Control type="file" id="resume" className="input" required onChange={handleFileChange} />
              </Form.Group>
            </Col>
          </Row>
          <Row>
