...
const EmployerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Perform employer login logic, check credentials against the database
    ...
    <div className="container d-flex justify-content-center align-items-center" style={{ height: '100vh' }}>
      <div>
        ...
        <div className="d-flex justify-content-center form">
          <Button variant="link" className="login-button" onClick={() => navigate('/employer/employersignup')}>
